...
<script src="<?= theme_path ?>/js/libs/jquery.animate3.js"></script>
...
<script src="<?= theme_path ?>/js/pm.kenzoinit.js"></script>
<script src="<?= theme_path ?>/js/pm.navigationmanager.js"></script>
<script src="<?= theme_path ?>/js/pm.resize.js"></script>
<script src="<?= theme_path ?>/js/pm.transitionmanager.js"></script>
<script src="<?= theme_path ?>/js/pm.utils.kenzo.js"></script>
